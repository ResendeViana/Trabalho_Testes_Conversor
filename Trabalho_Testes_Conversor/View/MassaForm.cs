...
{
    public partial class MassaForm : Form
    {
        public MassaForm()
        {
            InitializeComponent();
        ...
        private void btnConverter_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(txtImperial.Text))
            {
                ...
                MessageBox.Show(
                    string.Format("Resultado da conversão: {0} {2} = {1} {3}", txtImperial.Text, OperacoesMatematicas.LbToKg(valor), "Lbs", "Kg"),
                    "Resultado",
            ...
            else if (!string.IsNullOrWhiteSpace(txtMetrico.Text))
            {
                ...
                MessageBox.Show(
                    string.Format("Resultado da conversão: {0} {2} = {1} {3}", txtMetrico.Text, OperacoesMatematicas.KgToLb(valor), "Kg", "Lbs"),
                    "Resultado",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Information
                    );
