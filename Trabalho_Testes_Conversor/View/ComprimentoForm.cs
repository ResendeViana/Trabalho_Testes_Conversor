...
{
    public partial class ComprimentoForm : Form
    {
        public ComprimentoForm()
        {
            InitializeComponent();
        }
        ...
        private void btnConverter_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(txtImperial.Text))
            {
                ...
                MessageBox.Show(
                    string.Format("Resultado da conversão: {0} {2} = {1} {3}", txtImperial.Text, OperacoesMatematicas.FtToM(valor),"Ft","M"),
                    "Resultado",
            ...
            else if (!string.IsNullOrWhiteSpace(txtMetrico.Text))
            {
                ...
                MessageBox.Show(
                    string.Format("Resultado da conversão: {0} {2} = {1} {3}", txtMetrico.Text, OperacoesMatematicas.MToFt(valor), "M", "Ft"),
                    "Resultado",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Information
                    );
